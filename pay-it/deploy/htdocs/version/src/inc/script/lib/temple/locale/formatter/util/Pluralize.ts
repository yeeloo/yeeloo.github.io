...
export default class Pluralize {
	 ...
	 * @returns string
	 */
	public static capitalizeSame( word:string, sampleWord:string ):string
	{
	 ...
	 * @returns {{}}
	 */
	public static toKeys( keys:string ){
	...
	private static suffixRules:any[][] = [
		// common suffixes
		[ /man$/i, 'men' ],
		[ /([lm])ouse$/i, '$1ice' ],
		[ /tooth$/i, 'teeth' ],
	 ...
	 * @returns {string}
	 */
	public static pluralize( word:string, count:number, plural:any ):string
	{
		...
		if( lowerWord in Pluralize.uninflected ) return word;
	 ...
	 * @return void
	 */
	public static define( word:string, plural:any ):void{
