...
define(["require", "exports", "lib/temple/events/EventDispatcher", "lib/temple/core/DestructibleHelper", "../utils/Log"], function (require, exports, EventDispatcher_1, DestructibleHelper_1, Log_1) {
    /**
    ...
    var AbstractComponentController = (function (_super) {
        ...
        AbstractComponentController.prototype.setTemplate = function (template) {
            ...
            if ($(template).filter(':not(text)').length > 1) {
                Log_1.default.error('Temple.Component.AbstractComponentController', 'Component template has multiple root elements. Knockout bindings will only be applied to the first root element!');
            }
    ...
    exports.default = AbstractComponentController;
});
