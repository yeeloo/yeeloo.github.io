interface IType
{
	...
	is:(value:any, type:Function) => boolean;
}
...
Type.getType = function(value:any):string
{
 ...
 * @returns {boolean}
 */
Type.isNumber = function(value:any):boolean
{
	return !isNaN(value);
};
 ...
 * @returns {boolean}
 */
Type.isPrimitive = function(value:any):boolean
{
	switch (typeof value)
	{
		case Type.STRING:
 ...
 * @returns {boolean}
 */
Type.is = function(value:any, type:Function):boolean
{
