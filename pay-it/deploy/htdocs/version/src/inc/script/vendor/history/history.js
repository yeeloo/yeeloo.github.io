// local modification: AMD wrapper and require Browser class
define(['lib/temple/utils/Browser'], function(Browser)
{
	// local modification: only use this in IE
	if (Browser.default.name !== "ie")
	{
		return;
	}
  ...
  // local modification, return history as AMD
