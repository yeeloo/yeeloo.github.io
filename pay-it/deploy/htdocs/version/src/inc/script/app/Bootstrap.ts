...
if (window['isMobile'])
{
	...
	// optionally, redirect to mobile index
	// redirect should be done as early as possible
	//document.location.href = '/m/';
}

var sitemap = 'app/config/sitemap';
...
], function (sitemap, Main) {
	new Main.default(sitemap.default);
});
